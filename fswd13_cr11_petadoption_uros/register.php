...
$error = false;
$fname = $lname = $email = $adress = $phone = $pass = $picture = '';
$fnameError = $lnameError = $emailError = $adressError  = $phoneError = $passError = $picError = '';
if (isset($_POST['btn-signup'])) {
    ...
    if (!$error) {
        ...
        $query = "INSERT INTO user(first_name, last_name, email, password, phone, adress, picture)
                  VALUES('$fname', '$lname', '$email', '$password' , '$phone', '$adress', '$picture->fileName')";
...
<input type ="text"  name="fname"  class="form-control"  placeholder="First name" maxlength="50" value="<?php echo $fname ?>"  />           
            ...
            <input type="text"  name="adress" class="form-control" placeholder="Enter Your Adress" maxlength="50" value ="<?php echo $adress ?>"/>
            ...
            <hr/>
            <a href="products/index.php">Sign in Here...</a>
  </form> 
